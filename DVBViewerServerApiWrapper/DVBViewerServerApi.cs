...
namespace DVBViewerServerApiWrapper
{
    ...
    public class DVBViewerServerApi
    {
        ...
        /// <summary>
        /// <para>
        /// Wenn der DMS und eine APP auf der selben Maschine laufen, kann ein Bypass gesetzt werden, welcher direkt auf die Mediendatei verweist. Das sorgt dafür, dass der Wrapper, bei Play, keine Playlisten als m3u für die UPnP streams erstellt. Es wird direkt die Mediendatei zurückgegeben.
        /// </para>
        /// <para>
        ...
        ///// <summary>
        ///// Das wird aktuell nicht genutzt, aber soll noch nicht entfernt werden.
        ///// </summary>
